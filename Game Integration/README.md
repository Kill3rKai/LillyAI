...
- Built a system that allows LillyAI to understand actions and events in that game.
- Built a system that allows LillyAI to decide on an action to make.
- Built a system that allows LillyAI to execute that action in the game.
